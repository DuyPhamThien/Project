    ...
    render() {
        return (
            <Dialog header={this.props.header} footer={this.props.footer} visible={this.props.visible} style={{ width: '400px' }} onHide={() => this.props.onHide('displayADD')}>
                <div className={this.props.titile == "Them thanh cong" || this.props.titile == "Xoa thanh cong" || this.props.titile == "Sua thanh cong" ? "text" : "text-red"}>{this.props.titile}</div>
                ...
                {this.props.titile == "Sua thanh cong" &&  <Button icon="pi pi-check icon-add" className=" p-mr-3 p-button-rounded p-button-outlined  wi p-button-success"  />}
